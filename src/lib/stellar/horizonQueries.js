...
import { Horizon, TransactionBuilder, Networks, StrKey, Asset } from '@stellar/stellar-sdk'
...
/** @typedef {import('@stellar/stellar-sdk').Horizon.ServerApi.AccountRecord} AccountRecord */
/** @typedef {import('@stellar/stellar-sdk').Horizon.HorizonApi.ErrorResponseData} ErrorResponseData */
/** @typedef {import('@stellar/stellar-sdk').Horizon.ServerApi.PaymentOperationRecord} PaymentOperationRecord */
/** @typedef {import('@stellar/stellar-sdk').Horizon.HorizonApi.BalanceLine} BalanceLine */
/** @typedef {import('@stellar/stellar-sdk').Horizon.HorizonApi.BalanceLineAsset} BalanceLineAsset */
/** @typedef {import('@stellar/stellar-sdk').Transaction} Transaction */
/** @typedef {import('@stellar/stellar-sdk').Horizon.ServerApi.PaymentPathRecord} PaymentPathRecord */
