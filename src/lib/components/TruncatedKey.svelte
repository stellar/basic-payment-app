<script>
    /**
     * @description The `TruncatedKey.svelte` component accepts a Stellar key
     * (either public key or secret key) and returns a truncated version of it,
     * designed to flexibly fit its parent container. It also includes a copy
     * button to let the user easily copy/paste the value of `keyText`.
     */
    ...
    // display the contat names, when possible. This `export let` property
